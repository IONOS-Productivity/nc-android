 ...
 */
public class TeamFoldersPathPredicate implements PathPredicate {
	private final HidrivePathProvider pathProvider;

	@Inject
	public TeamFoldersPathPredicate(HidrivePathProvider pathProvider) {
		this.pathProvider = pathProvider;
	}

	@Override
	public boolean satisfied(String path) {
		return !path.startsWith(this.pathProvider.getUsersFolderPath());
	}
}
