...
import com.strato.hidrive.common_ui.activity.BasePhraseActivity
import com.strato.hidrive.common_ui.window.WindowWrapper
...
import com.strato.hidrive.scanbot.screens.base.BaseScreen.ViewModel

internal abstract class BaseActivity<E : Event, S : State<E>, VM : ViewModel<E, S>> : BasePhraseActivity() {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		WindowWrapper(window).setStatusBarColor(ContextCompat.getColor(context, R.color.system_bar_read_mode_color))
