...
import com.strato.hidrive.scanbot.screens.camera.image_picker.ImagePickerLauncher
import com.strato.hidrive.scanbot.screens.camera.ui_components.CameraViewController
import com.strato.hidrive.scanbot.screens.camera.ui_components.ImportProgressDialog
import com.strato.hidrive.scanbot.screens.common.use_case.open_screen.OpenScreen
...
internal class CameraActivity : BaseActivity<Event, State, ViewModel>() {
	...
	private val decodingProgressDialog = LockProgressDialog()
