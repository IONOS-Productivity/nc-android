...
import com.ionos.player.util.getDisplayHeight
import com.ionos.player.util.getDisplayWidth
...
class VideoFileFragment : Fragment(), PlaybackModel.Listener {
    ...
    private fun loadFileThumbnail() {
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            val thumbnailSize = context.resources.getDimension(R.dimen.player_full_screen_audio_player_album_cover_width)
