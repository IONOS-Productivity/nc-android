...
public class AudioPlayerEventTrackerPlayerControlViewListener implements PlayerControlViewListener {

	private final AudioPlayerEventTracker eventTracker;

	public AudioPlayerEventTrackerPlayerControlViewListener(AudioPlayerEventTracker eventTracker) {
