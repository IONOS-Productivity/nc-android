...
import com.strato.hidrive.player.tracking.AudioPlayerEventTrackerPlayerControlViewListener;
...
import com.strato.hidrive.player.views.player.fragment.AudioPlayerSourceFragmentFactory;
...
public class AudioPlayerView extends PlayerView {
	...
	private AudioPlayerEventTrackerPlayerControlViewListener audioPlayerEventTrackerPlayerControlViewListener;
	private final CompositeDisposable compositeDisposable = new CompositeDisposable();
	protected AudioPlayerEventTracker eventTracker;

	public AudioPlayerView(Context context, AudioPlayerEventTracker eventTracker) {
		super(context);
		...
		this.audioPlayerEventTrackerPlayerControlViewListener = new AudioPlayerEventTrackerPlayerControlViewListener(this.eventTracker);
	...
	protected void onAttachedToWindow() {
		...
		this.playerControlView.addListener(this.audioPlayerEventTrackerPlayerControlViewListener);
	...
	protected void onDetachedFromWindow() {
		...
		this.playerControlView.removeListener(this.audioPlayerEventTrackerPlayerControlViewListener);
		...
		public boolean onToolbarItemClick(ToolbarItem item) {
			...
			switch (item.getType()) {
				case INFO:
					...
					return true;
				case SIMULATE_FAKE_ERROR:
					playerModel.simulateError();
					return true;
				default:
