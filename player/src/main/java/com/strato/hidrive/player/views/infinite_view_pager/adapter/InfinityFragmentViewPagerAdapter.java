package com.strato.hidrive.player.views.infinite_view_pager.adapter;
...
public class InfinityFragmentViewPagerAdapter<T> extends AbstractFragmentPagerAdapter<T> {
	...
	public InfinityFragmentViewPagerAdapter(FragmentManager fragmentManager, ViewPagerFragmentFactory<T> playerSourceFragmentFactory) {
