...
public interface Scrollable {
	...
	@Deprecated
	void setScrollViewCallbacks(ObservableScrollView.ObservableScrollViewCallbacks listener);
	 ...
	 * @since 1.7.0
	 */
	void addScrollViewCallbacks(ObservableScrollView.ObservableScrollViewCallbacks listener);
	 ...
	 * @since 1.7.0
	 */
	void removeScrollViewCallbacks(ObservableScrollView.ObservableScrollViewCallbacks listener);
